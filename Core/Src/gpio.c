...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USART1_PV_GPIO_Port, USART1_PV_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : USART1_PV_Pin */
  GPIO_InitStruct.Pin = USART1_PV_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USART1_PV_GPIO_Port, &GPIO_InitStruct);
