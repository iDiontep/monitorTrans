...
uint32_t frameBuf[(800 * 600) / 4] LOCATION_ATTRIBUTE_32("TouchGFX_Framebuffer");
}
...
void TouchGFXGeneratedHAL::initialize()
{
    ...
    if (HAL_GFXMMU_ConfigLut(&hgfxmmu, 0, 600, (uint32_t)touchgfx_gfxmmu_lut_config) != HAL_OK)
    {
        while (1);
    }
