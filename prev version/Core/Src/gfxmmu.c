...
void MX_GFXMMU_Init(void)
{
  ...
  hgfxmmu.Init.Buffers.Buf0Address = 0x0;
  hgfxmmu.Init.Buffers.Buf1Address = 0x0000ffff;
  hgfxmmu.Init.Buffers.Buf2Address = 0x0;
  hgfxmmu.Init.Buffers.Buf3Address = 0x0000ffff;
